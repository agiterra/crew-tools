...
// NOTE: agent ↔ screen reconciliation (including cross-machine safety) moved
// to the RealityLayer — see reality.test.ts. The reconciler is now a pure
// metadata healer for panes, tabs, and themes.
